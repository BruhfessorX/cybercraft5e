...
## Bloodlines
At creation, choose one Vampyrus bloodline. Each grants additional features. Ascendant Traits have a requirement of the relevant ability score being 19+, noted on the trait to use them.
...
- **Ascendant Trait - Dawnblood Vitality (Constitution):** When you finish a short rest in daylight, you regain an additional 1d6 hit points and reduce your corruption by 1 (if applicable). The first time you drop below half your hit points each day, you gain temporary hit points equal to your level.  
...
- **Ascendant Trait - Blood Frenzy (Strength):** When you reduce a creature to 0 HP, you may use your bonus action to move up to half your speed and make one melee attack. Once per long rest.  
...
- **Ascendant Trait – Sovereign Will (Charisma):** Once per long rest, as an action, you exude an aura of command for 1 minute. Hostile creatures within 30 feet must make a Charisma saving throw (DC = 8 + your Charisma modifier + proficiency bonus) or become charmed or frightened (your choice) for the duration.  
...
- **Ascendant Trait – Adaptive Evolution (Constitution or Charisma):** Once per long rest, as a bonus action, you can temporarily gain one active bloodline ability from another Vampyrus archetype for 1 minute.
